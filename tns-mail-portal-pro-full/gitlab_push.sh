...
cd "$(dirname "$0")/tns-mail-portal-pro-full" || { echo "Project folder not found"; exit 1; }
...
git add .
 git commit -m "init: TNS Mail Portal Pro (React+Tailwind, Express, Worker, Redis, Postgres)"
